...
using JS.Abp.DataDictionary.Blazor.Server.Host.Components;
...
[DependsOn(
    ...
    typeof(DataDictionaryBlazorServerModule)
)]
public class DataDictionaryBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(DataDictionaryDomainModule).Assembly,
                typeof(DataDictionaryDomainSharedModule).Assembly,
                typeof(DataDictionaryApplicationModule).Assembly,
                typeof(DataDictionaryApplicationContractsModule).Assembly,
                typeof(DataDictionaryBlazorHostModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("DataDictionary");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles(new BundleFile("/JS.Abp.DataDictionary.Blazor.Server.Host.styles.css", true));
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<DataDictionaryDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}JS.Abp.DataDictionary.Domain", Path.DirectorySeparatorChar)));
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<DataDictionaryApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}JS.Abp.DataDictionary.Application", Path.DirectorySeparatorChar)));
                options.FileSets.ReplaceEmbeddedByPhysical<DataDictionaryBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(DataDictionaryBlazorHostModule).Assembly;
        });

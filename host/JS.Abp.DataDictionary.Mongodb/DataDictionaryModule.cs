...
using JS.Abp.DataDictionary.Menus;
...
using DataDictionaryDbContext = JS.Abp.DataDictionary.Data.DataDictionaryDbContext;
...
public class DataDictionaryModule : AbpModule
{
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<DataDictionaryModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<DataDictionaryModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(DataDictionaryModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddMongoDbContext<DataDictionaryDbContext>(options =>
        {
